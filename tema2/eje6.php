...
<body>
    ...
    //El documento nacional de identidad DNI en España consta de un numero de 8 cifras y de una letra. La letra del 
    ...
    //Seleccionar una letra asociada a dicho número en la siguiente tabla: 0 -> T, 1 -> R, 2 -> W, 3 -> A, 4 -> G, 5 -> M, 
