    ...
    if (isset($_SESSION['usuario'])) {
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: #2a2a2c;" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="enrutador.php?accion=inicio">
                    <div class="sidebar-brand-text mx-3">REGALOS</div>
                ...
                <li class="nav-item">
                <center><a class="collapse-item" href="./enrutador.php?accion=inicio" style="color:white; margin-top: 15px; ">REGALOS</a>
                </center>
                </li>
                <li>
                <center>
                <a class="collapse-item" href="#" data-toggle="modal" data-target="#modalNuevoRegalo" style="color:white; margin-top: 15px; ">NUEVO REGALO</a>
                </center>
                </li>
